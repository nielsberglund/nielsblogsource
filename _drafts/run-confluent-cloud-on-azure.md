...
An environment is a container for Kafka clusters, and we see in *Figure 11* a button (outlined in red) *Create cluster on my own*. Let's click that button:
